...
const Navbar: React.FC = () => {
  ...
  return (
    <NavContainer>
      <LogoSection onClick={() => navigate('/')}> {/* Redirige al inicio al dar clic al logo */}
      ...
      <NavItemsSection>
        {/* 3. Agregamos el onClick para redirigir a la ruta /cart */}
        <IconButton 
          aria-label="cart" 
        ...
        {logged ? (
          <UserMenu>
            ...
            <UserName onClick={() => navigate('/perfil')} style={{ cursor: 'pointer' }}>
